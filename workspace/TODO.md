...
<todo id="seed-projects">
Seed initial portfolio projects
Use the /admin panel to upload Joey&#39;s artwork images and create the first batch of projects from ArtStation.
</todo>


<todo id="lightbox-gallery">
Add lightbox to project detail gallery
Clicking any gallery image on the ProjectDetailPage should open a full-screen lightbox with prev/next navigation.
</todo>

<todo id="seo-meta">
Add per-page SEO meta tags
Use react-helmet or Vite&#39;s html plugin to inject dynamic title + og:image tags per project for social sharing.
</todo>
